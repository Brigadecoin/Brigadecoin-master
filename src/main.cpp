...
unsigned int nStakeMinAge = 60 * 60 * 10;	// minimum age for coin age: 10hr
...
int64 nChainStartTime = 1403179978;
...
const string strMessageMagic = "Brigadecoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Brigadecoin
    bool fStrictPayToScriptHash = true; // Always active in Brigadecoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Brigadecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "1403179978Brigade";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1403179978;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1839321;
       if ( false  && (block.GetHash() != hashGenesisBlock)) {
        ...
        assert(block.hashMerkleRoot == uint256("4602a34b385aaf26050006822edbb3f4b48b3965650c0f1ad7a32805b1b30569"));
...
// The characters are rarely used upper BRIGII, not valid as UTF-8, and produce
